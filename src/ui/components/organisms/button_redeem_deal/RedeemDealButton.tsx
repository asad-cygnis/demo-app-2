...
import { supportedOrderTypes } from "models/BarMenu";
  ...
  const startMenuDetailScreenOrUpdateCartFromRedeem = (
    ...
    if (menuType !== null && menuType !== undefined) {
      if (offer.menu.have_modifiers) {
        ...
        AppLog.log(
          () =>
            "in dispatch startMenuDetailScreen: offers" +
        ...
        AppLog.log(
          () =>
            ...
            JSON.stringify(supportedOrderTypes(offer.menu)),
          TAG.EXCLUSIVE_OFFER
        );
        startMenuDetailScreen(
          menuType,
      ...
      // SimpleToast.show("This deal is not available at the moment.");
      startMenuDetailScreen(
        supportedOrderTypes(offer.menu),
        offer.establishment_id!,
        type,
      ...
      //     establishment_id: offer.establishment_id,
      //     id: offer.menu.id,
      //     cart_type: supportedOrderTypes(offer.menu)
      //   })
      // );
    }
  };
