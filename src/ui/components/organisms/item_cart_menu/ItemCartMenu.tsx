  ...
  const updateCart = useCallback(
    async (stepperCount: number, shouldAdd: boolean) => {
      ...
      if (data.group_type === EProductGroupType.SINGLE) {
        ...
        data.have_modifiers &&
          data.sub_menus?.map((subMenu) => {
            subMenu.modifiers !== null &&
              subMenu.modifiers !== undefined &&
      ...
      if (data.group_type === EProductGroupType.BUNDLE) {
        let menuIds: number[] = [];
        ...
        addToCartRequestModel.current.sub_menu_ids = data.sub_menu_ids!;
      }
          ...
          <View style={[styles.productPriceContainer]}>
            <Stepper
              ...
              shouldDisableLeftButton={
                data.exclusive_offer_id ? true : shouldDisableStepper
              }
