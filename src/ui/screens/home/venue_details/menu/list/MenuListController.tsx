...
const MenuListController: FC<Props> = ({ menuType }) => {
  ...
  useEffect(() => {
    if (refreshingEvent?.SUCCESSFULL_ITEM_ADDED) {
      ...
      AppLog.log(
        () =>
          "Listening event.quantity at MenuListController " +
          event.cart_item_id,
        TAG.CART
      );
      updateMenuList(
  ...
  const updateMenuList = (
    ...
    AppLog.log(
      () =>
        "Listening here at MenuListController " +
        JSON.stringify(menu) +
        " " +
        quantity +
        " " +
    ...
    menuSegments &&
      ...
      menuSegments?.filter((segment) => {
        AppLog.log(
          () => "menusegment" + JSON.stringify(segment),
          TAG.CART
        );
    ...
    AppLog.log(
      () =>
        "\n\nafter Listening at MenuListController " +
        JSON.stringify(menu) +
        " " +
        quantity +
        " " +
