...
const useNotificationHandler = () => {
  ...
  function handleNotification(
    ...
    const notificationActions: HandleNotificationLiteralType = {
      [NotificationType.CHALKBOARD]: () =>
        navigateToChalkBoard(notification),
      [NotificationType.EDITS]: () => navigateToEditsScreen(notification),
      [NotificationType.EVENT]: () => navigateToChalkBoard(notification),
      ...
      [NotificationType.VOUCHER]: () => navigateToChalkBoard(notification)
    };
  ...
  function navigateToChalkBoard(notification: Notification) {
    let name: keyof HomeStackParamList = "VenueDetails";
    AppLog.log(
      () => "Notification ChalkBoard function: " + notification.type,
      TAG.VENUE
    );
    let _data = {
      screenName: name,
